...
def plot_excel_data(file_path, save_folder, start_value, end_value):
    ...
    plt.ylabel('Intesnity [µV]', fontsize = 20)
    plt.grid(True)
    ...
    save_path = os.path.join(save_folder, 'HPLCCryoPrep.png')
...
file_path = 'D:\HPLC\Prep MgATP 1min.xlsx'  # Pfad zu Ihrer Excel-Datei
save_folder = 'D:\HPLC'  # Pfad zum Speicherordner
start_value = 7  # Startwert für die x-Achse
end_value = 12  # Endwert für die x-Achse
